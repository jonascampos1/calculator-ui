        ...
        <v-row>
          ...
          <v-col>
            ...
            <v-row justify="center">
              <v-card width="300">
                <v-row class="ma-1">
                <v-text-field class="mr-1" ref="v1" variant="outlined"></v-text-field> <h1>+</h1> <v-text-field class="ml-1" variant="outlined"></v-text-field>
              </v-row>
              </v-card>
            </v-row>
            </v-sheet>
            <v-col> 
                <v-row justify="space-between" class="mt-2">
                  <v-btn color="red" @click="">Make operation</v-btn>
                </v-row>
              </v-col>
